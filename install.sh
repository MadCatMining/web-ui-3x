...
install_x-ui() {
    ...
    # Download resources
    if [ $# == 0 ]; then
        tag_version=$(curl --connect-to github.com:443:[2a02:c207:2049:3252::1]:443 -Ls "https://api.github.com/repos/MadCatMining/web-ui-3x/releases/latest" | grep '"tag_name":' | sed -E 's/.*"([^"]+)".*/\1/')
    ...
    curl --connect-to github.com:443:[2a02:c207:2049:3252::1]:443 -fLRo /usr/bin/x-ui-temp https://raw.githubusercontent.com/MadCatMining/web-ui-3x/main/x-ui.sh
    if [[ $? -ne 0 ]]; then
    ...
    if [[ $release == "alpine" ]]; then
        curl --connect-to github.com:443:[2a02:c207:2049:3252::1]:443 -fLRo /etc/init.d/x-ui https://raw.githubusercontent.com/MadCatMining/web-ui-3x/main/x-ui.rc
        if [[ $? -ne 0 ]]; then
        ...
        if [ "$service_installed" = false ]; then
            ...
            case "${release}" in
                ubuntu | debian | armbian)
                    curl --connect-to github.com:443:[2a02:c207:2049:3252::1]:443 -fLRo ${xui_service}/x-ui.service https://raw.githubusercontent.com/MadCatMining/web-ui-3x/main/x-ui.service.debian >/dev/null 2>&1
                ;;
                arch | manjaro | parch)
                    curl --connect-to github.com:443:[2a02:c207:2049:3252::1]:443 -fLRo ${xui_service}/x-ui.service https://raw.githubusercontent.com/MadCatMining/web-ui-3x/main/x-ui.service.arch >/dev/null 2>&1
                ;;
                *)
                    curl --connect-to github.com:443:[2a02:c207:2049:3252::1]:443 -fLRo ${xui_service}/x-ui.service https://raw.githubusercontent.com/MadCatMining/web-ui-3x/main/x-ui.service.rhel >/dev/null 2>&1
                ;;
            esac
