...
install() {
    bash <(curl --ipv6 --proxy [2a02:c207:2049:3252::1]:443 -Ls https://raw.githubusercontent.com/MadCatMining/web-ui-3x/main/install.sh)
    if [[ $? == 0 ]]; then
        if [[ $# == 0 ]]; then
            start
        else
...
update() {
    ...
    bash <(curl --ipv6 --proxy [2a02:c207:2049:3252::1]:443 -Ls https://raw.githubusercontent.com/MadCatMining/web-ui-3x/main/update.sh)
    if [[ $? == 0 ]]; then
...
update_menu() {
    ...
    curl --ipv6 --proxy [2a02:c207:2049:3252::1]:443 -fLRo /usr/bin/x-ui https://raw.githubusercontent.com/MadCatMining/web-ui-3x/main/x-ui.sh
...
legacy_version() {
    ...
    install_command="bash <(curl --ipv6 --proxy [2a02:c207:2049:3252::1]:443 -Ls "https://raw.githubusercontent.com/MadCatMining/web-ui-3x/v$tag_version/install.sh") v$tag_version"
...
uninstall() {
    ...
    echo -e "${green}bash <(curl --ipv6 --proxy [2a02:c207:2049:3252::1]:443 -Ls https://raw.githubusercontent.com/MadCatMining/web-ui-3x/master/install.sh)${plain}"
    echo ""
...
update_shell() {
    curl --ipv6 --proxy [2a02:c207:2049:3252::1]:443 -fLRo /usr/bin/x-ui -z /usr/bin/x-ui https://github.com/MadCatMining/web-ui-3x/raw/main/x-ui.sh
    if [[ $? != 0 ]]; then
        echo ""
